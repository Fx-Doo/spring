...
public:
	...
	void UnitDestroyed(const CUnit& destroyed, const CUnit* attacker, int weaponDefID, int attackerTeamID);
	void UnitDamaged(const CUnit& damaged, const CUnit* attacker, float damage, int weaponDefID, int projectileID, bool paralyzer, int attackerTeamID);
